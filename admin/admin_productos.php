...
// Seguridad: Verificar que el usuario esté logueado y tenga permisos
...
// Procesar el borrado de un producto de forma segura
if (isset($_POST['borrar_producto'])) {
    ...
    try {
        ...
        // Si falla, es porque el producto ya se ha vendido y está en la tabla Opera
...
<div style="background-color: #FFF7EE; padding: 40px 20px; text-align: center; border-bottom: 1px solid rgba(235, 98, 80, 0.1);">
    <h1 style="font-family: 'Playfair Display', serif; color: #EB6250; margin: 0;">Gestión de Tienda</h1>
    <p style="color: #886752; font-family: 'Poppins', sans-serif;">Control de inventario y catálogo de productos</p>
</div>
...
<main style="max-width: 1000px; margin: 40px auto; padding: 0 20px; font-family: 'Poppins', sans-serif;">
    ...
    <?php if ($mensaje_error): ?>
        <div style="background: #fce8e6; color: #c5221f; padding: 15px; border-radius: 12px; margin-bottom: 30px; border: 1px solid #f5c6cb;">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            <thead style="background: #FFF7EE; color: #886752;">
                <tr>
                    ...
                    <th style="padding: 20px;">Stock y Acciones</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f0f0f0;">
                    ...
                    <td style="padding: 20px;">
                        <div style="display: flex; gap: 10px; align-items: center;">
                            ...
                            <form method="POST" action="admin_productos.php" style="margin: 0;" onsubmit="return confirm('¿Seguro que quieres borrar este producto?');">
                                <input type="hidden" name="id_producto" value="<?= $p['id_producto'] ?>">
                                <button type="submit" name="borrar_producto" title="Eliminar producto" style="background: #ffebee; color: #c62828; border: none; padding: 10px 15px; border-radius: 10px; cursor: pointer; font-weight: 500; transition: 0.2s;" onmouseover="this.style.background='#ffcdd2'" onmouseout="this.style.background='#ffebee'">
                                    🗑️
                                </button>
                            </form>
                        </div>
                ...
                <tr>
                    <td colspan="4" style="padding: 40px; text-align: center; color: #777;">No hay productos registrados en la tienda.</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
